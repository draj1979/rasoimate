...
const TRUSTED = [
  { name: "Ghar Ka Khana Collective", sub: "Community" },
  { name: "Spice Route Kitchen", sub: "Creators" },
  { name: "Annapurna Home Cooks", sub: "Network" },
  { name: "Tadka Tales", sub: "Stories" },
  { name: "Rasoi Diaries", sub: "Recipes" },
  { name: "Swaad Studio", sub: "Kitchen" },
];
    ...
    <div className="min-h-screen w-full bg-bone text-fg2">
      ...
      <section className="border-y bg-bone-50" style={{ borderColor: "var(--border)" }}>
        <div className="mx-auto max-w-[1240px] px-6 py-10 md:px-10">
          <div className="text-center text-[12px] tracking-[-0.005em] text-fg3">
            Loved by home cooks and food lovers across India
          </div>
      ...
      >
        <div className="mx-auto max-w-[1240px] px-6 py-24 text-center md:px-10 md:py-32">
          ...
          >
            We&apos;re cooking up something special. Join the waitlist and be first to say
            &ldquo;Hey RasoiMate&rdquo; when we launch.
          </p>
          <div className="mt-9 flex justify-center">
            <WaitlistForm source="RasoiMate" variant="dark" />
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          <div className="mx-auto flex max-w-[1240px] px-6 py-5 text-[12px] md:px-10" style={{ color: "rgba(239,233,228,0.55)" }}>
